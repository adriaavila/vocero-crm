...
const plans: { id: SaaSPlan; name: string; price: string; description: string; features: string[] }[] = [
  { id: "basic", name: "Esencial", price: "$49/mes", description: "Que nadie se quede sin respuesta.", features: ["Tu número de siempre, sin cambiar nada", "Contesta fuera de tu horario", "Una bandeja con toda la conversación", "Ficha del cliente y su historial"] },
  { id: "pro", name: "Completo", price: "$99/mes", description: "Cuando la consulta ya vale plata. 7 días de prueba gratis.", features: ["Todo lo de Esencial", "Tus ventas en etapas y agenda de citas", "Responde todo el día", "Hasta 3 usuarios"] },
];
