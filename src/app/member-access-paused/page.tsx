  ...
  return (
    <main className="grid min-h-dvh place-items-center bg-subtle px-5 py-10">
      <section className="w-full max-w-md rounded-2xl border bg-background p-7 text-center shadow-md sm:p-9">
        ...
        <h1 className="mt-2 text-2xl font-[700] tracking-tight">El negocio está en Esencial</h1>
        <p className="mt-3 text-sm leading-6 text-text-2">
          Los datos y conversaciones siguen guardados. El propietario puede reactivar Completo para devolver el acceso a los miembros del equipo.
        </p>
