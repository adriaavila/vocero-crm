...
| type | text NOT NULL default 'text' | `text` \| `image` \| `audio` \| `video` \| `document` \| `sticker` \| `location` \| `contacts` \| `template` \| `button` \| `interactive` (respuestas a botones: body = la opción elegida) |
